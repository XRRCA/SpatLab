...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 335.0, 639.0, 377.0, 134.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 250.593414, 541.5, 73.0, 37.0 ],
					"style" : "",
					"text" : "binaural preview"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 11.598909, 549.0, 236.994507, 22.0 ],
					"style" : "",
					"text" : "spat5.virtualspeakers~ @speakers 24"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 387.0, 444.0, 173.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 612.0, 72.5, 53.0, 22.0 ],
					"style" : "",
					"text" : "/type $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 612.0, 108.5, 121.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 13.0, 240.0, 273.410675, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 348.0, 13.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 348.0, 47.0, 217.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 352.0, 232.0, 78.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 24,
					"numoutlets" : 0,
					"patching_rect" : [ 11.598909, 599.0, 260.5, 22.0 ],
					"style" : "",
					"text" : "hoa.dac~ 1-24"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 11.714294, 314.0, 265.0, 134.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 25,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "" ],
					"patching_rect" : [ 11.714294, 167.0, 285.813629, 22.0 ],
					"style" : "",
					"text" : "spat5.pan~ @inputs 1 @outputs 24"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 361.5, 256.0, 309.0, 256.0, 309.0, 157.0, 21.214294, 157.0 ],
					"order" : 1,
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 361.5, 534.0, 21.098909, 534.0 ],
					"order" : 0,
					"source" : [ "obj-11", 0 ]
				}
